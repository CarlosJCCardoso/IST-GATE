...
backup_url = 'http://127.0.0.1:5001'
...
def registerGate():
    # Replicate request
    try:
        r = requests.post(f'{backup_url}/API/gates/', json = request.get_json())
    except:
        pass
...
def listGates():
    # Replicate request
    try:
        r = requests.get(f'{backup_url}/API/gates/')
    except:
        pass
...
def gateInfo(gate_id):
    # Replicate request
    try:
        r = requests.get(f'{backup_url}/API/gates/{gate_id}')
    except:
        pass
...
def incrementActivations(gate_id):
    # Replicate request
    try:
        r = requests.post(f'{backup_url}/API/gates/{gate_id}/activations/', json = request.get_json())
    except:
        pass
...
def validateSecret(gate_id, secret):
    # Replicate request
    try:
        r = requests.get(f'{backup_url}/API/gates/{gate_id}/secrets/{secret}/')
    except:
        pass
...
def registerAttempt(gate_id):
    # Replicate request
    try:
        r = requests.post(f'{backup_url}/API/gates/{gate_id}/attempts/', json = request.get_json())
    except:
        pass
...
def listAttempts(gate_id):
    # Replicate request
    try:
        r = requests.get(f'{backup_url}/API/gates/{gate_id}/attempts')
    except:
        pass
